...
@push('addon-script')
  <script>
    ...
    title.addEventListener('change', function () {
      fetch('/users/posts/create/slug?title=' + title.value)
...
<form action="/posts" class="mt-4" method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control shadow-none" id="title" name="title" value="{{ old('title') }}" required autofocus>
  </div>
  <div class="mb-3">
    <label for="slug" class="form-label ">Slug</label>
    <input type="text" class="form-control shadow-none" id="slug" name="slug" name="slug" value="{{ old('slug') }}" readonly>
  </div>
  <div class="mb-3">
