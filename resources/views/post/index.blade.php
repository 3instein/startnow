                ...
                <div class="card border-0 px-4 mb-3 py-4 position-relative">
                    <form action="{{ route('comments.store') }}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control shadow-none" name="body" placeholder="Leave a comment here"
                        ...
                        <div class="d-flex rounded" role="group" aria-label="Basic outlined example"
                            ...
                            <form action="{{ route('posts.vote', $post->slug) }}" class="vote-form width-100"
                                ...
                                <button
                                    ...
                                    id="btn-upvote">
                                    <i
                                        class="bi bi-arrow-up-circle text-base-color fs-5 me-2"></i>
                                    upvote
                                </button>
                            </form>
                            <form action="{{ route('posts.vote', $post->slug) }}" class="vote-form width-100">
                                ...
                                <button
                                    ...
                                    id="btn-downvote">
                                    <i
                                        class="bi bi-arrow-down-circle text-base-color fs-5 me-2"></i>
                                    downvote
                                </button>
                            </form>
                        </div>
