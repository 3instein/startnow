                    ...
                    <div class="d-flex rounded" role="group" aria-label="Basic outlined example"
                        ...
                        <form action="{{ route('posts.vote', $post->slug) }}" class="vote-form width-100" method="POST"
                            ...
                            <button
                                ...
                                id="btn-upvote">
                                <i
                                    class="bi {{ $postVoter->type == 'upvote' && $postVoter->type != null ? 'bi-arrow-up-circle-fill' : 'bi-arrow-up-circle' }} text-base-color fs-5 me-2"></i>
                                upvote
                            </button>
                        </form>
                        <form action="{{ route('posts.vote', $post->slug) }}" class="vote-form width-100">
                            ...
                            <button
                                ...
                                id="btn-downvote">
                                <i class="bi {{ $postVoter->type == 'downvote' && $postVoter->type != null ? 'bi-arrow-down-circle-fill' : 'bi-arrow-down-circle' }} text-base-color fs-5 me-2"></i>
                                downvote
                            </button>
                        </form>
                    </div>
